...
class SwitchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create switch" do
    assert_difference('Switch.count') do
      post switches_url, params: { switch: { local_ip: @switch.local_ip, name: @switch.name, pass: @switch.pass, user: @switch.user } }
    end
  ...
  test "should update switch" do
    patch switch_url(@switch), params: { switch: { local_ip: @switch.local_ip, name: @switch.name, pass: @switch.pass, user: @switch.user } }
